...
def main():
    ...
    res=pbi_client.execute_queries_by_name(workspace_name=args.workspace_name, dataset_name=args.ds_name, query_list=queries,  serializerSettings=serializerSettings)
